...
const domExampleWrap: any = document.querySelector(".example-wrap");
const domProblemsList: any = document.querySelectorAll(".problems-wrap_item");
...
const showExampleWrap = (...args: any[]) => {
    const [event] = args;
